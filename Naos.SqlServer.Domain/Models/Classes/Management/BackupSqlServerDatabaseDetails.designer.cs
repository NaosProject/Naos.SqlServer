    ...
    public partial class BackupSqlServerDatabaseDetails : IModel<BackupSqlServerDatabaseDetails>
    {
            ...
            PropertyPathTracker propertyPathTracker = null)
        {
            ...
            void ValidateProperties()
            {
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.BackupTo, options, propertyPathTracker, nameof(this.BackupTo));
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.Cipher, options, propertyPathTracker, nameof(this.Cipher));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.CompressionOption, options, propertyPathTracker, nameof(this.CompressionOption));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.Description, options, propertyPathTracker, nameof(this.Description));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.Encryptor, options, propertyPathTracker, nameof(this.Encryptor));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.EncryptorName, options, propertyPathTracker, nameof(this.EncryptorName));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
