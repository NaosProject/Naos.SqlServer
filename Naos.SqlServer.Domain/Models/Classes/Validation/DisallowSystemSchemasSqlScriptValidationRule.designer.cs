...
namespace Naos.SqlServer.Domain
{
    ...
    [Serializable]
    public partial class DisallowSystemSchemasSqlScriptValidationRule : IModel<DisallowSystemSchemasSqlScriptValidationRule>
    {
        /// <summary>
        /// Determines whether two objects of type <see cref="DisallowSystemSchemasSqlScriptValidationRule"/> are equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are equal; otherwise false.</returns>
        public static bool operator ==(DisallowSystemSchemasSqlScriptValidationRule left, DisallowSystemSchemasSqlScriptValidationRule right)
        {
        ...
        /// <summary>
        /// Determines whether two objects of type <see cref="DisallowSystemSchemasSqlScriptValidationRule"/> are not equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are not equal; otherwise false.</returns>
        public static bool operator !=(DisallowSystemSchemasSqlScriptValidationRule left, DisallowSystemSchemasSqlScriptValidationRule right) => !(left == right);

        /// <inheritdoc />
        public bool Equals(DisallowSystemSchemasSqlScriptValidationRule other)
        {
        ...
        /// <inheritdoc />
        public override bool Equals(object obj) => this == (obj as DisallowSystemSchemasSqlScriptValidationRule);
        ...
        /// <inheritdoc />
        public new DisallowSystemSchemasSqlScriptValidationRule DeepClone() => (DisallowSystemSchemasSqlScriptValidationRule)this.DeepCloneInternal();
        ...
        {
            var result = new DisallowSystemSchemasSqlScriptValidationRule(
                                 id);
        ...
        {
            var result = Invariant($"Naos.SqlServer.Domain.DisallowSystemSchemasSqlScriptValidationRule: Id = {this.Id?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}.");
