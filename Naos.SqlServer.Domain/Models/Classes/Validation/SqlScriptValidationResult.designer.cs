...
namespace Naos.SqlServer.Domain
{
    ...
    public partial class SqlScriptValidationResult : IModel<SqlScriptValidationResult>
    {
        ...
        public bool Equals(SqlScriptValidationResult other)
        {
            ...
            var result = this.Violations.IsEqualTo(other.Violations);
        ...
        {
            var result = Invariant($"Naos.SqlServer.Domain.SqlScriptValidationResult: Violations = {this.Violations?.ToString() ?? "<null>"}.");
