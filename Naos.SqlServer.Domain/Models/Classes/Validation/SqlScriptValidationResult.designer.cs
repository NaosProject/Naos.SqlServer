    ...
    public partial class SqlScriptValidationResult : IModel<SqlScriptValidationResult>
    {
        ...
        public bool Equals(SqlScriptValidationResult other)
        {
            ...
            var result = this.TargetSqlServerVersion.IsEqualTo(other.TargetSqlServerVersion)
                      && this.Violations.IsEqualTo(other.Violations);
        ...
        /// <summary>
        /// Deep clones this object with a new <see cref="Violations" />.
        /// </summary>
        /// <param name="violations">The new <see cref="Violations" />.  This object will NOT be deep cloned; it is used as-is.</param>
        /// <returns>New <see cref="SqlScriptValidationResult" /> using the specified <paramref name="violations" /> for <see cref="Violations" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002:DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Maintainability", "CA1502:AvoidExcessiveComplexity")]
        [SuppressMessage("Microsoft.Design", "CA1054:UriParametersShouldNotBeStrings")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic")]
        public SqlScriptValidationResult DeepCloneWithViolations(IReadOnlyList<SqlScriptValidationRuleViolation> violations)
        {
            var result = new SqlScriptValidationResult(
                                 this.TargetSqlServerVersion.DeepClone(),
                                 violations);
        ...
        {
            var result = Invariant($"Naos.SqlServer.Domain.SqlScriptValidationResult: TargetSqlServerVersion = {this.TargetSqlServerVersion.ToString() ?? "<null>"}, Violations = {this.Violations?.ToString() ?? "<null>"}.");
            ...
            PropertyPathTracker propertyPathTracker = null)
        {
            ...
            void ValidateProperties()
            {
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.Violations, options, propertyPathTracker, nameof(this.Violations));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
