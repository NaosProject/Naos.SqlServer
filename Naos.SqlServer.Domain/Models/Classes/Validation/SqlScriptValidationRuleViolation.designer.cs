...
namespace Naos.SqlServer.Domain
{
    ...
    [Serializable]
    public partial class SqlScriptValidationRuleViolation : IModel<SqlScriptValidationRuleViolation>
    {
        /// <summary>
        /// Determines whether two objects of type <see cref="SqlScriptValidationRuleViolation"/> are equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are equal; otherwise false.</returns>
        public static bool operator ==(SqlScriptValidationRuleViolation left, SqlScriptValidationRuleViolation right)
        {
        ...
        /// <summary>
        /// Determines whether two objects of type <see cref="SqlScriptValidationRuleViolation"/> are not equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are not equal; otherwise false.</returns>
        public static bool operator !=(SqlScriptValidationRuleViolation left, SqlScriptValidationRuleViolation right) => !(left == right);

        /// <inheritdoc />
        public bool Equals(SqlScriptValidationRuleViolation other)
        {
            ...
            var result = this.Rule.IsEqualTo(other.Rule)
                      && this.Offset.IsEqualTo(other.Offset)
        ...
        /// <inheritdoc />
        public override bool Equals(object obj) => this == (obj as SqlScriptValidationRuleViolation);
        ...
        /// <inheritdoc />
        public SqlScriptValidationRuleViolation DeepClone()
        {
        ...
        /// <summary>
        /// Deep clones this object with a new <see cref="Rule" />.
        /// </summary>
        /// <param name="rule">The new <see cref="Rule" />.  This object will NOT be deep cloned; it is used as-is.</param>
        /// <returns>New <see cref="SqlScriptValidationRuleViolation" /> using the specified <paramref name="rule" /> for <see cref="Rule" /> and a deep clone of every other property.</returns>
        ...
        public SqlScriptValidationRuleViolation DeepCloneWithRule(SqlScriptValidationRuleBase rule)
        {
            var result = new SqlScriptValidationRuleViolation(
                                 rule,
                                 this.Offset.DeepClone(),
        ...
        /// <returns>New <see cref="SqlScriptValidationRuleViolation" /> using the specified <paramref name="offset" /> for <see cref="Offset" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002:DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Maintainability", "CA1502:AvoidExcessiveComplexity")]
        [SuppressMessage("Microsoft.Design", "CA1054:UriParametersShouldNotBeStrings")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic")]
        public SqlScriptValidationRuleViolation DeepCloneWithOffset(int offset)
        {
            var result = new SqlScriptValidationRuleViolation(
                                 this.Rule?.DeepClone(),
                                 offset,
        ...
        /// <returns>New <see cref="SqlScriptValidationRuleViolation" /> using the specified <paramref name="details" /> for <see cref="Details" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002:DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Maintainability", "CA1502:AvoidExcessiveComplexity")]
        [SuppressMessage("Microsoft.Design", "CA1054:UriParametersShouldNotBeStrings")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic")]
        public SqlScriptValidationRuleViolation DeepCloneWithDetails(string details)
        {
            var result = new SqlScriptValidationRuleViolation(
                                 this.Rule?.DeepClone(),
                                 this.Offset.DeepClone(),
            ...
            PropertyPathTracker propertyPathTracker = null)
        {
            ...
            void ValidateProperties()
            {
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.Rule, options, propertyPathTracker, nameof(this.Rule));
