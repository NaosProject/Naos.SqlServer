...
namespace Naos.SqlServer.Domain
{
    ...
    [Serializable]
    public partial class DisallowedJoinShapesSqlScriptValidationRule : IModel<DisallowedJoinShapesSqlScriptValidationRule>
    {
        /// <summary>
        /// Determines whether two objects of type <see cref="DisallowedJoinShapesSqlScriptValidationRule"/> are equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are equal; otherwise false.</returns>
        public static bool operator ==(DisallowedJoinShapesSqlScriptValidationRule left, DisallowedJoinShapesSqlScriptValidationRule right)
        {
        ...
        /// <summary>
        /// Determines whether two objects of type <see cref="DisallowedJoinShapesSqlScriptValidationRule"/> are not equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are not equal; otherwise false.</returns>
        public static bool operator !=(DisallowedJoinShapesSqlScriptValidationRule left, DisallowedJoinShapesSqlScriptValidationRule right) => !(left == right);

        /// <inheritdoc />
        public bool Equals(DisallowedJoinShapesSqlScriptValidationRule other)
        {
            ...
            var result = this.Id.IsEqualTo(other.Id, StringComparer.Ordinal)
                      && this.DisallowedShapes.IsEqualTo(other.DisallowedShapes);

            return result;
        }

        /// <inheritdoc />
        public override bool Equals(object obj) => this == (obj as DisallowedJoinShapesSqlScriptValidationRule);

        /// <inheritdoc />
        public override int GetHashCode() => HashCodeHelper.Initialize()
            .Hash(this.Id)
            .Hash(this.DisallowedShapes)
            .Value;

        /// <inheritdoc />
        public new DisallowedJoinShapesSqlScriptValidationRule DeepClone() => (DisallowedJoinShapesSqlScriptValidationRule)this.DeepCloneInternal();
        ...
        public override SqlScriptValidationRuleBase DeepCloneWithId(string id)
        {
            var result = new DisallowedJoinShapesSqlScriptValidationRule(
                                 this.DisallowedShapes.DeepClone(),
                                 id);
        ...
        /// <summary>
        /// Deep clones this object with a new <see cref="DisallowedShapes" />.
        /// </summary>
        /// <param name="disallowedShapes">The new <see cref="DisallowedShapes" />.  This object will NOT be deep cloned; it is used as-is.</param>
        /// <returns>New <see cref="DisallowedJoinShapesSqlScriptValidationRule" /> using the specified <paramref name="disallowedShapes" /> for <see cref="DisallowedShapes" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002:DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Maintainability", "CA1502:AvoidExcessiveComplexity")]
        [SuppressMessage("Microsoft.Design", "CA1054:UriParametersShouldNotBeStrings")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic")]
        public DisallowedJoinShapesSqlScriptValidationRule DeepCloneWithDisallowedShapes(JoinShapeIssues disallowedShapes)
        {
            var result = new DisallowedJoinShapesSqlScriptValidationRule(
                                 disallowedShapes,
                                 this.Id?.DeepClone());
        ...
        {
            var result = Invariant($"Naos.SqlServer.Domain.DisallowedJoinShapesSqlScriptValidationRule: Id = {this.Id?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, DisallowedShapes = {this.DisallowedShapes.ToString() ?? "<null>"}.");
            ...
            PropertyPathTracker propertyPathTracker = null)
        {
            ...
            void ValidateProperties()
            {
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.DisallowedShapes, options, propertyPathTracker, nameof(this.DisallowedShapes));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
