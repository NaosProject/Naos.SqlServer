...
namespace Naos.SqlServer.Domain
{
    ...
    [Serializable]
    public partial class DisallowAdHocDistributedQueriesSqlScriptValidationRule : IModel<DisallowAdHocDistributedQueriesSqlScriptValidationRule>
    {
        /// <summary>
        /// Determines whether two objects of type <see cref="DisallowAdHocDistributedQueriesSqlScriptValidationRule"/> are equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are equal; otherwise false.</returns>
        public static bool operator ==(DisallowAdHocDistributedQueriesSqlScriptValidationRule left, DisallowAdHocDistributedQueriesSqlScriptValidationRule right)
        {
        ...
        /// <summary>
        /// Determines whether two objects of type <see cref="DisallowAdHocDistributedQueriesSqlScriptValidationRule"/> are not equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are not equal; otherwise false.</returns>
        public static bool operator !=(DisallowAdHocDistributedQueriesSqlScriptValidationRule left, DisallowAdHocDistributedQueriesSqlScriptValidationRule right) => !(left == right);

        /// <inheritdoc />
        public bool Equals(DisallowAdHocDistributedQueriesSqlScriptValidationRule other)
        {
        ...
        /// <inheritdoc />
        public override bool Equals(object obj) => this == (obj as DisallowAdHocDistributedQueriesSqlScriptValidationRule);
        ...
        /// <inheritdoc />
        public new DisallowAdHocDistributedQueriesSqlScriptValidationRule DeepClone() => (DisallowAdHocDistributedQueriesSqlScriptValidationRule)this.DeepCloneInternal();
        ...
        {
            var result = new DisallowAdHocDistributedQueriesSqlScriptValidationRule(
                                 id);
        ...
        {
            var result = Invariant($"Naos.SqlServer.Domain.DisallowAdHocDistributedQueriesSqlScriptValidationRule: Id = {this.Id?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}.");
