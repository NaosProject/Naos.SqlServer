...
namespace Naos.SqlServer.Domain
{
    ...
    [Serializable]
    public partial class ColumnScopedSimpleConjunctiveFilterSqlScriptValidationRule : IModel<ColumnScopedSimpleConjunctiveFilterSqlScriptValidationRule>
    {
        /// <summary>
        /// Determines whether two objects of type <see cref="ColumnScopedSimpleConjunctiveFilterSqlScriptValidationRule"/> are equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are equal; otherwise false.</returns>
        public static bool operator ==(ColumnScopedSimpleConjunctiveFilterSqlScriptValidationRule left, ColumnScopedSimpleConjunctiveFilterSqlScriptValidationRule right)
        {
        ...
        /// <summary>
        /// Determines whether two objects of type <see cref="ColumnScopedSimpleConjunctiveFilterSqlScriptValidationRule"/> are not equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are not equal; otherwise false.</returns>
        public static bool operator !=(ColumnScopedSimpleConjunctiveFilterSqlScriptValidationRule left, ColumnScopedSimpleConjunctiveFilterSqlScriptValidationRule right) => !(left == right);

        /// <inheritdoc />
        public bool Equals(ColumnScopedSimpleConjunctiveFilterSqlScriptValidationRule other)
        {
        ...
        /// <inheritdoc />
        public override bool Equals(object obj) => this == (obj as ColumnScopedSimpleConjunctiveFilterSqlScriptValidationRule);
        ...
        /// <inheritdoc />
        public new ColumnScopedSimpleConjunctiveFilterSqlScriptValidationRule DeepClone() => (ColumnScopedSimpleConjunctiveFilterSqlScriptValidationRule)this.DeepCloneInternal();
        ...
        /// <returns>New <see cref="ColumnScopedSimpleConjunctiveFilterSqlScriptValidationRule" /> using the specified <paramref name="columns" /> for <see cref="Columns" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002:DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Maintainability", "CA1502:AvoidExcessiveComplexity")]
        [SuppressMessage("Microsoft.Design", "CA1054:UriParametersShouldNotBeStrings")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic")]
        public ColumnScopedSimpleConjunctiveFilterSqlScriptValidationRule DeepCloneWithColumns(IReadOnlyCollection<SchemaQualifiedColumnName> columns)
        {
            var result = new ColumnScopedSimpleConjunctiveFilterSqlScriptValidationRule(
                                 columns,
                                 this.Id?.DeepClone());
        ...
        {
            var result = Invariant($"Naos.SqlServer.Domain.ColumnScopedSimpleConjunctiveFilterSqlScriptValidationRule: Id = {this.Id?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Columns = {this.Columns?.ToString() ?? "<null>"}.");
