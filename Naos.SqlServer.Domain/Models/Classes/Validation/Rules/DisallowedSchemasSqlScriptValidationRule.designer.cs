...
namespace Naos.SqlServer.Domain
{
    ...
    [Serializable]
    public partial class DisallowedSchemasSqlScriptValidationRule : IModel<DisallowedSchemasSqlScriptValidationRule>
    {
        /// <summary>
        /// Determines whether two objects of type <see cref="DisallowedSchemasSqlScriptValidationRule"/> are equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are equal; otherwise false.</returns>
        public static bool operator ==(DisallowedSchemasSqlScriptValidationRule left, DisallowedSchemasSqlScriptValidationRule right)
        {
        ...
        /// <summary>
        /// Determines whether two objects of type <see cref="DisallowedSchemasSqlScriptValidationRule"/> are not equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are not equal; otherwise false.</returns>
        public static bool operator !=(DisallowedSchemasSqlScriptValidationRule left, DisallowedSchemasSqlScriptValidationRule right) => !(left == right);

        /// <inheritdoc />
        public bool Equals(DisallowedSchemasSqlScriptValidationRule other)
        {
        ...
        /// <inheritdoc />
        public override bool Equals(object obj) => this == (obj as DisallowedSchemasSqlScriptValidationRule);
        ...
        /// <inheritdoc />
        public new DisallowedSchemasSqlScriptValidationRule DeepClone() => (DisallowedSchemasSqlScriptValidationRule)this.DeepCloneInternal();
        ...
        /// <returns>New <see cref="DisallowedSchemasSqlScriptValidationRule" /> using the specified <paramref name="disallowedSchemas" /> for <see cref="DisallowedSchemas" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002:DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Maintainability", "CA1502:AvoidExcessiveComplexity")]
        [SuppressMessage("Microsoft.Design", "CA1054:UriParametersShouldNotBeStrings")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic")]
        public DisallowedSchemasSqlScriptValidationRule DeepCloneWithDisallowedSchemas(IReadOnlyCollection<string> disallowedSchemas)
        {
            var result = new DisallowedSchemasSqlScriptValidationRule(
                                 disallowedSchemas,
                                 this.Id?.DeepClone());
        ...
        {
            var result = Invariant($"Naos.SqlServer.Domain.DisallowedSchemasSqlScriptValidationRule: Id = {this.Id?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, DisallowedSchemas = {this.DisallowedSchemas?.ToString() ?? "<null>"}.");
