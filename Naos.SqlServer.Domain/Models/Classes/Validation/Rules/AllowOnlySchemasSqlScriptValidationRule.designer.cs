...
namespace Naos.SqlServer.Domain
{
    ...
    [Serializable]
    public partial class AllowOnlySchemasSqlScriptValidationRule : IModel<AllowOnlySchemasSqlScriptValidationRule>
    {
        /// <summary>
        /// Determines whether two objects of type <see cref="AllowOnlySchemasSqlScriptValidationRule"/> are equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are equal; otherwise false.</returns>
        public static bool operator ==(AllowOnlySchemasSqlScriptValidationRule left, AllowOnlySchemasSqlScriptValidationRule right)
        {
        ...
        /// <summary>
        /// Determines whether two objects of type <see cref="AllowOnlySchemasSqlScriptValidationRule"/> are not equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are not equal; otherwise false.</returns>
        public static bool operator !=(AllowOnlySchemasSqlScriptValidationRule left, AllowOnlySchemasSqlScriptValidationRule right) => !(left == right);

        /// <inheritdoc />
        public bool Equals(AllowOnlySchemasSqlScriptValidationRule other)
        {
        ...
        /// <inheritdoc />
        public override bool Equals(object obj) => this == (obj as AllowOnlySchemasSqlScriptValidationRule);
        ...
        /// <inheritdoc />
        public new AllowOnlySchemasSqlScriptValidationRule DeepClone() => (AllowOnlySchemasSqlScriptValidationRule)this.DeepCloneInternal();
        ...
        /// <returns>New <see cref="AllowOnlySchemasSqlScriptValidationRule" /> using the specified <paramref name="sanctionedSchemas" /> for <see cref="SanctionedSchemas" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002:DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Maintainability", "CA1502:AvoidExcessiveComplexity")]
        [SuppressMessage("Microsoft.Design", "CA1054:UriParametersShouldNotBeStrings")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic")]
        public AllowOnlySchemasSqlScriptValidationRule DeepCloneWithSanctionedSchemas(IReadOnlyCollection<string> sanctionedSchemas)
        {
            var result = new AllowOnlySchemasSqlScriptValidationRule(
                                 sanctionedSchemas,
                                 this.Id?.DeepClone());
        ...
        {
            var result = Invariant($"Naos.SqlServer.Domain.AllowOnlySchemasSqlScriptValidationRule: Id = {this.Id?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, SanctionedSchemas = {this.SanctionedSchemas?.ToString() ?? "<null>"}.");
