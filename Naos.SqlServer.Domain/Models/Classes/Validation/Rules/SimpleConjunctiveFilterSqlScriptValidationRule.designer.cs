...
namespace Naos.SqlServer.Domain
{
    ...
    [Serializable]
    public partial class SimpleConjunctiveFilterSqlScriptValidationRule : IModel<SimpleConjunctiveFilterSqlScriptValidationRule>
    {
        /// <summary>
        /// Determines whether two objects of type <see cref="SimpleConjunctiveFilterSqlScriptValidationRule"/> are equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are equal; otherwise false.</returns>
        public static bool operator ==(SimpleConjunctiveFilterSqlScriptValidationRule left, SimpleConjunctiveFilterSqlScriptValidationRule right)
        {
        ...
        /// <summary>
        /// Determines whether two objects of type <see cref="SimpleConjunctiveFilterSqlScriptValidationRule"/> are not equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are not equal; otherwise false.</returns>
        public static bool operator !=(SimpleConjunctiveFilterSqlScriptValidationRule left, SimpleConjunctiveFilterSqlScriptValidationRule right) => !(left == right);

        /// <inheritdoc />
        public bool Equals(SimpleConjunctiveFilterSqlScriptValidationRule other)
        {
        ...
        /// <inheritdoc />
        public override bool Equals(object obj) => this == (obj as SimpleConjunctiveFilterSqlScriptValidationRule);
        ...
        /// <inheritdoc />
        public new SimpleConjunctiveFilterSqlScriptValidationRule DeepClone() => (SimpleConjunctiveFilterSqlScriptValidationRule)this.DeepCloneInternal();
        ...
        {
            var result = new SimpleConjunctiveFilterSqlScriptValidationRule(
                                 id);
        ...
        {
            var result = Invariant($"Naos.SqlServer.Domain.SimpleConjunctiveFilterSqlScriptValidationRule: Id = {this.Id?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}.");
