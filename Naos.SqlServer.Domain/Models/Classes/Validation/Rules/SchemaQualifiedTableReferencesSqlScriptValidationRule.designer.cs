...
namespace Naos.SqlServer.Domain
{
    ...
    [Serializable]
    public partial class SchemaQualifiedTableReferencesSqlScriptValidationRule : IModel<SchemaQualifiedTableReferencesSqlScriptValidationRule>
    {
        /// <summary>
        /// Determines whether two objects of type <see cref="SchemaQualifiedTableReferencesSqlScriptValidationRule"/> are equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are equal; otherwise false.</returns>
        public static bool operator ==(SchemaQualifiedTableReferencesSqlScriptValidationRule left, SchemaQualifiedTableReferencesSqlScriptValidationRule right)
        {
        ...
        /// <summary>
        /// Determines whether two objects of type <see cref="SchemaQualifiedTableReferencesSqlScriptValidationRule"/> are not equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are not equal; otherwise false.</returns>
        public static bool operator !=(SchemaQualifiedTableReferencesSqlScriptValidationRule left, SchemaQualifiedTableReferencesSqlScriptValidationRule right) => !(left == right);

        /// <inheritdoc />
        public bool Equals(SchemaQualifiedTableReferencesSqlScriptValidationRule other)
        {
        ...
        /// <inheritdoc />
        public override bool Equals(object obj) => this == (obj as SchemaQualifiedTableReferencesSqlScriptValidationRule);
        ...
        /// <inheritdoc />
        public new SchemaQualifiedTableReferencesSqlScriptValidationRule DeepClone() => (SchemaQualifiedTableReferencesSqlScriptValidationRule)this.DeepCloneInternal();
        ...
        {
            var result = new SchemaQualifiedTableReferencesSqlScriptValidationRule(
                                 id);
        ...
        {
            var result = Invariant($"Naos.SqlServer.Domain.SchemaQualifiedTableReferencesSqlScriptValidationRule: Id = {this.Id?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}.");
