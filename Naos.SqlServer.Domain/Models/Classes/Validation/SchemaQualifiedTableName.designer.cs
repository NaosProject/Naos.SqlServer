...
namespace Naos.SqlServer.Domain
{
    ...
    [Serializable]
    public partial class SchemaQualifiedTableName : IModel<SchemaQualifiedTableName>
    {
        /// <summary>
        /// Determines whether two objects of type <see cref="SchemaQualifiedTableName"/> are equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are equal; otherwise false.</returns>
        public static bool operator ==(SchemaQualifiedTableName left, SchemaQualifiedTableName right)
        {
        ...
        /// <summary>
        /// Determines whether two objects of type <see cref="SchemaQualifiedTableName"/> are not equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are not equal; otherwise false.</returns>
        public static bool operator !=(SchemaQualifiedTableName left, SchemaQualifiedTableName right) => !(left == right);

        /// <inheritdoc />
        public bool Equals(SchemaQualifiedTableName other)
        {
        ...
        /// <inheritdoc />
        public override bool Equals(object obj) => this == (obj as SchemaQualifiedTableName);
        ...
        /// <inheritdoc />
        public SchemaQualifiedTableName DeepClone()
        {
        ...
        /// <returns>New <see cref="SchemaQualifiedTableName" /> using the specified <paramref name="schemaName" /> for <see cref="SchemaName" /> and a deep clone of every other property.</returns>
        ...
        public SchemaQualifiedTableName DeepCloneWithSchemaName(string schemaName)
        {
            var result = new SchemaQualifiedTableName(
                                 schemaName,
                                 this.TableName?.DeepClone());
        ...
        /// <returns>New <see cref="SchemaQualifiedTableName" /> using the specified <paramref name="tableName" /> for <see cref="TableName" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002:DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Maintainability", "CA1502:AvoidExcessiveComplexity")]
        [SuppressMessage("Microsoft.Design", "CA1054:UriParametersShouldNotBeStrings")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic")]
        public SchemaQualifiedTableName DeepCloneWithTableName(string tableName)
        {
            var result = new SchemaQualifiedTableName(
                                 this.SchemaName?.DeepClone(),
                                 tableName);
