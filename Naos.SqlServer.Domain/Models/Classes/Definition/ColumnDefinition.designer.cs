...
namespace Naos.SqlServer.Domain
{
    ...
    public partial class ColumnDefinition : IModel<ColumnDefinition>
    {
        ...
        /// <returns>New <see cref="ColumnDefinition" /> using the specified <paramref name="name" /> for <see cref="Name" /> and a deep clone of every other property.</returns>
        ...
        public ColumnDefinition DeepCloneWithName(string name)
        {
            var result = new ColumnDefinition(
                                 name,
                                 this.SqlDataType?.DeepClone());
        ...
        /// <returns>New <see cref="ColumnDefinition" /> using the specified <paramref name="sqlDataType" /> for <see cref="SqlDataType" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002:DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Maintainability", "CA1502:AvoidExcessiveComplexity")]
        [SuppressMessage("Microsoft.Design", "CA1054:UriParametersShouldNotBeStrings")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic")]
        public ColumnDefinition DeepCloneWithSqlDataType(SqlDataTypeRepresentationBase sqlDataType)
        {
            var result = new ColumnDefinition(
                                 this.Name?.DeepClone(),
                                 sqlDataType);
        ...
        {
            var result = Invariant($"Naos.SqlServer.Domain.ColumnDefinition: Name = {this.Name?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, SqlDataType = {this.SqlDataType?.ToString() ?? "<null>"}.");
