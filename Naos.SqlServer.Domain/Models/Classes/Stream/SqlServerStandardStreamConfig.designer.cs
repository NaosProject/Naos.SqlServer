    ...
    public partial class SqlServerStandardStreamConfig : IModel<SqlServerStandardStreamConfig>
    {
            ...
            PropertyPathTracker propertyPathTracker = null)
        {
            ...
            void ValidateProperties()
            {
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.DefaultConnectionTimeout, options, propertyPathTracker, nameof(this.DefaultConnectionTimeout));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.DefaultCommandTimeout, options, propertyPathTracker, nameof(this.DefaultCommandTimeout));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
