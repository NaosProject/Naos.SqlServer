    ...
    public partial class IdentifiedType : IModel<IdentifiedType>
    {
            ...
            PropertyPathTracker propertyPathTracker = null)
        {
            ...
            void ValidateProperties()
            {
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.IdWithoutVersion, options, propertyPathTracker, nameof(this.IdWithoutVersion));
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.IdWithVersion, options, propertyPathTracker, nameof(this.IdWithVersion));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
