    ...
    public partial class DecimalSqlDataTypeRepresentation : IModel<DecimalSqlDataTypeRepresentation>
    {
            ...
            PropertyPathTracker propertyPathTracker = null)
        {
            ...
            void ValidateProperties()
            {
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.Precision, options, propertyPathTracker, nameof(this.Precision));
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.Scale, options, propertyPathTracker, nameof(this.Scale));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
