...
namespace Naos.SqlServer.Domain
{
    ...
    [Serializable]
    public partial class IntSqlDataTypeRepresentation : IModel<IntSqlDataTypeRepresentation>
    {
        /// <summary>
        /// Determines whether two objects of type <see cref="IntSqlDataTypeRepresentation"/> are equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are equal; otherwise false.</returns>
        public static bool operator ==(IntSqlDataTypeRepresentation left, IntSqlDataTypeRepresentation right)
        {
        ...
        /// <summary>
        /// Determines whether two objects of type <see cref="IntSqlDataTypeRepresentation"/> are not equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are not equal; otherwise false.</returns>
        public static bool operator !=(IntSqlDataTypeRepresentation left, IntSqlDataTypeRepresentation right) => !(left == right);

        /// <inheritdoc />
        public bool Equals(IntSqlDataTypeRepresentation other)
        {
        ...
        /// <inheritdoc />
        public override bool Equals(object obj) => this == (obj as IntSqlDataTypeRepresentation);

        /// <inheritdoc />
        public override int GetHashCode() => HashCodeHelper.Initialize()
            .Hash("IntSqlDataTypeRepresentation")
            .Value;

        /// <inheritdoc />
        public new IntSqlDataTypeRepresentation DeepClone() => (IntSqlDataTypeRepresentation)this.DeepCloneInternal();

        /// <inheritdoc />
        [SuppressMessage("Microsoft.Maintainability", "CA1502:AvoidExcessiveComplexity")]
        protected override SqlDataTypeRepresentationBase DeepCloneInternal()
        {
            var result = new IntSqlDataTypeRepresentation();
        ...
        {
            var result = Invariant($"Naos.SqlServer.Domain.IntSqlDataTypeRepresentation: <no properties>.");
