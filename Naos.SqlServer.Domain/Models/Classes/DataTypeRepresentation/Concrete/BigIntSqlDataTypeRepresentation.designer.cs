...
namespace Naos.SqlServer.Domain
{
    ...
    [Serializable]
    public partial class BigIntSqlDataTypeRepresentation : IModel<BigIntSqlDataTypeRepresentation>
    {
        /// <summary>
        /// Determines whether two objects of type <see cref="BigIntSqlDataTypeRepresentation"/> are equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are equal; otherwise false.</returns>
        public static bool operator ==(BigIntSqlDataTypeRepresentation left, BigIntSqlDataTypeRepresentation right)
        {
        ...
        /// <summary>
        /// Determines whether two objects of type <see cref="BigIntSqlDataTypeRepresentation"/> are not equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are not equal; otherwise false.</returns>
        public static bool operator !=(BigIntSqlDataTypeRepresentation left, BigIntSqlDataTypeRepresentation right) => !(left == right);

        /// <inheritdoc />
        public bool Equals(BigIntSqlDataTypeRepresentation other)
        {
        ...
        /// <inheritdoc />
        public override bool Equals(object obj) => this == (obj as BigIntSqlDataTypeRepresentation);

        /// <inheritdoc />
        public override int GetHashCode() => HashCodeHelper.Initialize()
            .Hash("BigIntSqlDataTypeRepresentation")
            .Value;

        /// <inheritdoc />
        public new BigIntSqlDataTypeRepresentation DeepClone() => (BigIntSqlDataTypeRepresentation)this.DeepCloneInternal();

        /// <inheritdoc />
        [SuppressMessage("Microsoft.Maintainability", "CA1502:AvoidExcessiveComplexity")]
        protected override SqlDataTypeRepresentationBase DeepCloneInternal()
        {
            var result = new BigIntSqlDataTypeRepresentation();
        ...
        {
            var result = Invariant($"Naos.SqlServer.Domain.BigIntSqlDataTypeRepresentation: <no properties>.");
