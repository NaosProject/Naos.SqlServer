...
INSERT INTO [{streamName}].[{Table.Name}] ([{nameof(Status)}]) VALUES ('{Database.Domain.HandlingStatus.None}')
INSERT INTO [{streamName}].[{Table.Name}] ([{nameof(Status)}]) VALUES ('{Database.Domain.HandlingStatus.RetryFailed}')
INSERT INTO [{streamName}].[{Table.Name}] ([{nameof(Status)}]) VALUES ('{Database.Domain.HandlingStatus.Requested}')
INSERT INTO [{streamName}].[{Table.Name}] ([{nameof(Status)}]) VALUES ('{Database.Domain.HandlingStatus.Unknown}')
INSERT INTO [{streamName}].[{Table.Name}] ([{nameof(Status)}]) VALUES ('{Database.Domain.HandlingStatus.SelfCanceledRunning}')
INSERT INTO [{streamName}].[{Table.Name}] ([{nameof(Status)}]) VALUES ('{Database.Domain.HandlingStatus.CanceledRunning}')
...
INSERT INTO [{streamName}].[{Table.Name}] ([{nameof(Status)}]) VALUES ('{Database.Domain.HandlingStatus.Blocked}')
			");
