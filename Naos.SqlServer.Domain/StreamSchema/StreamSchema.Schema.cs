...
namespace Naos.SqlServer.Domain
{
    ...
    public partial class StreamSchema
    {
            ...
            string streamName)
        {
            ...
            else
            {
                throw new NotSupportedException(
                    FormattableString.Invariant($"Type {protocolType} is not supported for granting table/sproc/function access."));
            }
            ...
            string streamName)
        {
            ...
            var result = FormattableString.Invariant($@"{streamName}-{roleName}");
            return result;
        }
    }
}
