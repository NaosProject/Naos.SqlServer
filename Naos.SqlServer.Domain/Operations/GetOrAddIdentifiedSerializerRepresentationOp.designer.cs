    ...
    public partial class GetOrAddIdentifiedSerializerRepresentationOp : IModel<GetOrAddIdentifiedSerializerRepresentationOp>
    {
            ...
            PropertyPathTracker propertyPathTracker = null)
        {
            ...
            void ValidateProperties()
            {
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.SerializationFormat, options, propertyPathTracker, nameof(this.SerializationFormat));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
