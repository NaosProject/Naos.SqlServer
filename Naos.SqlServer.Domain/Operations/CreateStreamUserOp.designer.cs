    ...
    public partial class CreateStreamUserOp : IModel<CreateStreamUserOp>
    {
            ...
            PropertyPathTracker propertyPathTracker = null)
        {
            ...
            void ValidateProperties()
            {
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.LoginName, options, propertyPathTracker, nameof(this.LoginName));
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.StreamAccessKinds, options, propertyPathTracker, nameof(this.StreamAccessKinds));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.ShouldCreateLogin, options, propertyPathTracker, nameof(this.ShouldCreateLogin));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
