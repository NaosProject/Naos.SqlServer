...
namespace Naos.SqlServer.Domain
{
    ...
    [Serializable]
    public partial class ValidateSqlScriptOp : IModel<ValidateSqlScriptOp>
    {
        /// <summary>
        /// Determines whether two objects of type <see cref="ValidateSqlScriptOp"/> are equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are equal; otherwise false.</returns>
        public static bool operator ==(ValidateSqlScriptOp left, ValidateSqlScriptOp right)
        {
        ...
        /// <summary>
        /// Determines whether two objects of type <see cref="ValidateSqlScriptOp"/> are not equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are not equal; otherwise false.</returns>
        public static bool operator !=(ValidateSqlScriptOp left, ValidateSqlScriptOp right) => !(left == right);

        /// <inheritdoc />
        public bool Equals(ValidateSqlScriptOp other)
        {
        ...
        /// <inheritdoc />
        public override bool Equals(object obj) => this == (obj as ValidateSqlScriptOp);
        ...
        /// </summary>
        /// <param name="sql">The new <see cref="Sql" />.  This object will NOT be deep cloned; it is used as-is.</param>
        /// <returns>New <see cref="ValidateSqlScriptOp" /> using the specified <paramref name="sql" /> for <see cref="Sql" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002:DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Maintainability", "CA1502:AvoidExcessiveComplexity")]
        [SuppressMessage("Microsoft.Design", "CA1054:UriParametersShouldNotBeStrings")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        ...
        /// <summary>
        /// Deep clones this object with a new <see cref="Rules" />.
        /// </summary>
        /// <param name="rules">The new <see cref="Rules" />.  This object will NOT be deep cloned; it is used as-is.</param>
        /// <returns>New <see cref="ValidateSqlScriptOp" /> using the specified <paramref name="rules" /> for <see cref="Rules" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002:DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Maintainability", "CA1502:AvoidExcessiveComplexity")]
        [SuppressMessage("Microsoft.Design", "CA1054:UriParametersShouldNotBeStrings")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
            ...
            PropertyPathTracker propertyPathTracker = null)
        {
            ...
            void ValidateProperties()
            {
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.Rules, options, propertyPathTracker, nameof(this.Rules));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
