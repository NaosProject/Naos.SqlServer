...
namespace Naos.SqlServer.Domain
{
    ...
    public partial class GetIdAddIfNecessarySerializerRepresentationOp : IModel<GetIdAddIfNecessarySerializerRepresentationOp>
    {
        ...
        public bool Equals(GetIdAddIfNecessarySerializerRepresentationOp other)
        {
            ...
            var result = this.SerializerRepresentation.IsEqualTo(other.SerializerRepresentation)
                      && this.SerializationFormat.IsEqualTo(other.SerializationFormat)
                      && this.ResourceLocator.IsEqualTo(other.ResourceLocator);
        ...
        /// <returns>New <see cref="GetIdAddIfNecessarySerializerRepresentationOp" /> using the specified <paramref name="resourceLocator" /> for <see cref="ResourceLocator" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002: DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        [SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly")]
        [SuppressMessage("Microsoft.Naming", "CA1709:IdentifiersShouldBeCasedCorrectly")]
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic")]
        public GetIdAddIfNecessarySerializerRepresentationOp DeepCloneWithResourceLocator(SqlServerLocator resourceLocator)
        {
            var result = new GetIdAddIfNecessarySerializerRepresentationOp(
                                 resourceLocator,
                                 this.SerializerRepresentation?.DeepClone(),
        ...
        {
            var result = Invariant($"Naos.SqlServer.Domain.GetIdAddIfNecessarySerializerRepresentationOp: SerializerRepresentation = {this.SerializerRepresentation?.ToString() ?? "<null>"}, SerializationFormat = {this.SerializationFormat.ToString() ?? "<null>"}, ResourceLocator = {this.ResourceLocator?.ToString() ?? "<null>"}.");
