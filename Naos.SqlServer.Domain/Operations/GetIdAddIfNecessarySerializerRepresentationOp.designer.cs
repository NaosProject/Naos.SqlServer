...
namespace Naos.SqlServer.Domain
{
    ...
    public partial class GetIdAddIfNecessarySerializerRepresentationOp : IModel<GetIdAddIfNecessarySerializerRepresentationOp>
    {
        ...
        {
            var result = Invariant($"Naos.SqlServer.Domain.GetIdAddIfNecessarySerializerRepresentationOp: SerializerRepresentation = {this.SerializerRepresentation?.ToString() ?? "<null>"}, SerializationFormat = {this.SerializationFormat.ToString() ?? "<null>"}, SpecifiedResourceLocator = {this.SpecifiedResourceLocator?.ToString() ?? "<null>"}.");
