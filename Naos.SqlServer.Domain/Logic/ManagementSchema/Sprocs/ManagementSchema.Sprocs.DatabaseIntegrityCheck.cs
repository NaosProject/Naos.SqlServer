// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ManagementSchema.Sprocs.DatabaseIntegrityCheck.cs" company="Naos Project">
...
namespace Naos.SqlServer.Domain
{
    ...
    public static partial class ManagementSchema
    {
        public static partial class Sprocs
        {
            /// <summary>
            /// Stored procedure: DatabaseIntegrityCheck.
            /// </summary>
            public static class DatabaseIntegrityCheck
            {
                /// <summary>
                /// Gets the name.
                /// </summary>
                public static string Name => nameof(DatabaseIntegrityCheck);
...
@Execute nvarchar(max) = 'Y'
                ...
                {
                    var sprocName = Invariant($"[{streamName}].{nameof(DatabaseIntegrityCheck)}");
                    ...
                    bool asAlter = false)
                {
                    ...
                    var result = Invariant(
                        $@"
{createOrModify} PROCEDURE [dbo].[DatabaseIntegrityCheck]
