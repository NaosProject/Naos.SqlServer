// --------------------------------------------------------------------------------------------------------------------
// <copyright file="StreamSchema.Funcs.AdjustForPutStringSerializedId.cs" company="Naos Project">
...
namespace Naos.SqlServer.Domain
{
    ...
    public static partial class StreamSchema
    {
        ...
        {
            /// <summary>
            /// Function: AdjustForPutStringSerializedId.
            /// </summary>
            public static class AdjustForPutStringSerializedId
            {
                /// <summary>
                /// Gets the name of the function.
                /// </summary>
                public static string Name => nameof(AdjustForPutStringSerializedId);
...
BEGIN
    RETURN
        CASE
            WHEN @{InputParamName.StringSerializedId} IS NULL THEN '{Tables.Record.NullStringSerializedId}'
