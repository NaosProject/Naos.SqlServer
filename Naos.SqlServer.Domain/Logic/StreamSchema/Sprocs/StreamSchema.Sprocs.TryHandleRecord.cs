                    ...
                    var parameters = new List<SqlParameterDefinitionBase>()
                                     {
                                         ...
                                         new SqlInputParameterDefinition<string>(nameof(InputParamName.OrderRecordsBy), new StringSqlDataTypeRepresentation(false, 50), orderRecordsBy.ToString()),
                                         ...
                                         new SqlInputParameterDefinition<string>(nameof(InputParamName.TagIdsForEntryCsv), Tables.Record.TagIdsCsv.SqlDataType, tagIdsCsv),
                                         new SqlInputParameterDefinition<int>(nameof(InputParamName.InheritRecordTags), new IntSqlDataTypeRepresentation(), inheritRecordTags ? 1 : 0),
                                         new SqlInputParameterDefinition<long?>(nameof(InputParamName.MinimumInternalRecordId), Tables.Record.Id.SqlDataType, minimumInternalRecordId),
                                         new SqlOutputParameterDefinition<int>(nameof(OutputParamName.ShouldHandle), new IntSqlDataTypeRepresentation()),
                                         new SqlOutputParameterDefinition<int>(nameof(OutputParamName.IsBlocked), new IntSqlDataTypeRepresentation()),
                                         ...
                                         new SqlOutputParameterDefinition<string>(nameof(OutputParamName.StringSerializedId), Tables.Record.StringSerializedId.SqlDataType),
                                         new SqlOutputParameterDefinition<string>(nameof(OutputParamName.StringSerializedObject), Tables.Record.StringSerializedObject.SqlDataType),
                                         new SqlOutputParameterDefinition<byte[]>(nameof(OutputParamName.BinarySerializedObject), Tables.Record.BinarySerializedObject.SqlDataType),
