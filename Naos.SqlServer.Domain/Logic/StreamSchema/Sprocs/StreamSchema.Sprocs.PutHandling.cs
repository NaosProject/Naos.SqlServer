                    ...
                    var parameters = new List<SqlParameterRepresentationBase>()
                                     {
                                         ...
                                         new SqlInputParameterRepresentation<long>(nameof(InputParamName.RecordId), Tables.Handling.RecordId.SqlDataType, recordId),
                                         new SqlInputParameterRepresentation<string>(nameof(InputParamName.NewStatus), Tables.Handling.Status.SqlDataType, newStatus.ToString()),
