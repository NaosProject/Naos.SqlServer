// --------------------------------------------------------------------------------------------------------------------
// <copyright file="DatabaseObjectToScriptedDirectoryProcessor.cs" company="Naos Project">
...
namespace Naos.SqlServer.Protocol.Management
{
    ...
    public class DatabaseObjectToScriptedDirectoryProcessor
    {
        ...
        {
            new { tables }.AsArg().Must().NotBeNull();
        ...
        {
            new { roles }.AsArg().Must().NotBeNull();
        ...
        {
            new { indexes }.AsArg().Must().NotBeNull();
        ...
        {
            new { checks }.AsArg().Must().NotBeNull();
        ...
        {
            new { users }.AsArg().Must().NotBeNull();
        ...
        {
            new { userDefinedDataTypes }.AsArg().Must().NotBeNull();
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1031:DoNotCatchGeneralExceptionTypes", Justification = "Legacy code, not fixing right now.")]
