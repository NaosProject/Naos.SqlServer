...
namespace Naos.SqlServer.Domain.Test
{
    ...
    public static partial class CreateStreamUserOpTest
    {
        ...
        private static readonly ValidModelTestScenarios<CreateStreamUserOp> ValidModelTestScenarios = new ValidModelTestScenarios<CreateStreamUserOp>()
            .AddScenario(() =>
                new ValidModelTestScenario<CreateStreamUserOp>
                {
                    Name = "a dummy CreateStreamUserOp should be valid",
                    SystemUnderTest = A.Dummy<CreateStreamUserOp>(),
                });
