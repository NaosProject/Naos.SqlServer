    ...
    public static partial class ExecuteStoredProcedureOpTest
    {
                ...
                new StringRepresentationTestScenario<ExecuteStoredProcedureOp>
                {
                    ...
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedStringRepresentation<ExecuteStoredProcedureOp>
                        {
                            ...
                            ExpectedStringRepresentation = Invariant($"Naos.SqlServer.Domain.ExecuteStoredProcedureOp: Name = {systemUnderTest.Name?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, ParameterNameToDetailsMap = {systemUnderTest.ParameterNameToDetailsMap?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<ExecuteStoredProcedureOp> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<ExecuteStoredProcedureOp>()
                ...
                new ConstructorArgumentValidationTestScenario<ExecuteStoredProcedureOp>
                {
                    ...
                    ConstructionFunc = () =>
                    {
                        ...
                        var result = new ExecuteStoredProcedureOp(
                                             null,
                                             referenceObject.ParameterNameToDetailsMap);
            ...
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<ExecuteStoredProcedureOp>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'parameterNameToDetailsMap' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<ExecuteStoredProcedureOp>();
                    ...
                    ExpectedExceptionType = typeof(ArgumentNullException),
                    ExpectedExceptionMessageContains = new[] { "parameterNameToDetailsMap", },
                })
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<ExecuteStoredProcedureOp>
                {
                    Name = "constructor should throw ArgumentException when parameter 'parameterNameToDetailsMap' is an empty dictionary scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<ExecuteStoredProcedureOp>();
                    ...
                    ExpectedExceptionType = typeof(ArgumentException),
                    ExpectedExceptionMessageContains = new[] { "parameterNameToDetailsMap", "is an empty dictionary", },
                })
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<ExecuteStoredProcedureOp>
                {
                    Name = "constructor should throw ArgumentException when parameter 'parameterNameToDetailsMap' contains a key-value pair with a null value scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<ExecuteStoredProcedureOp>();

                        var dictionaryWithNullValue = referenceObject.ParameterNameToDetailsMap.ToDictionary(_ => _.Key, _ => _.Value);
                    ...
                    ExpectedExceptionType = typeof(ArgumentException),
                    ExpectedExceptionMessageContains = new[] { "parameterNameToDetailsMap", "contains at least one key-value pair with a null value", },
                });
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<ExecuteStoredProcedureOp> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<ExecuteStoredProcedureOp>()
            ...
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<ExecuteStoredProcedureOp>
                {
                    Name = "ParameterNameToDetailsMap should return same 'parameterNameToDetailsMap' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<ExecuteStoredProcedureOp>();
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<ExecuteStoredProcedureOp>
                        {
                            SystemUnderTest = new ExecuteStoredProcedureOp(
                                                      referenceObject.Name,
                                                      referenceObject.ParameterNameToDetailsMap),
                            ExpectedPropertyValue = referenceObject.ParameterNameToDetailsMap,
                        };

                        return result;
                    },
                    PropertyName = "ParameterNameToDetailsMap",
                });
        ...
        private static readonly DeepCloneWithTestScenarios<ExecuteStoredProcedureOp> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<ExecuteStoredProcedureOp>()
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<ExecuteStoredProcedureOp>
                {
                    Name = "DeepCloneWithParameterNameToDetailsMap should deep clone object and replace ParameterNameToDetailsMap with the provided parameterNameToDetailsMap",
                    WithPropertyName = "ParameterNameToDetailsMap",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<ExecuteStoredProcedureOp>();

                        var referenceObject = A.Dummy<ExecuteStoredProcedureOp>().ThatIs(_ => !systemUnderTest.ParameterNameToDetailsMap.IsEqualTo(_.ParameterNameToDetailsMap));

                        var result = new SystemUnderTestDeepCloneWithValue<ExecuteStoredProcedureOp>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.ParameterNameToDetailsMap,
                        };
                ...
                new EquatableTestScenario<ExecuteStoredProcedureOp>
                {
                    ...
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new ExecuteStoredProcedureOp[]
                    {
                        new ExecuteStoredProcedureOp(
                                ...
                                ReferenceObjectForEquatableTestScenarios.ParameterNameToDetailsMap),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new ExecuteStoredProcedureOp[]
                    {
                        ...
                        new ExecuteStoredProcedureOp(
                                ReferenceObjectForEquatableTestScenarios.Name,
                                A.Dummy<ExecuteStoredProcedureOp>().Whose(_ => !_.ParameterNameToDetailsMap.IsEqualTo(ReferenceObjectForEquatableTestScenarios.ParameterNameToDetailsMap)).ParameterNameToDetailsMap),
                    },
        ...
        public static class Cloning
        {
            ...
            public static void DeepClone___Should_deep_clone_object___When_called()
            {
                ...
                if (systemUnderTest.ParameterNameToDetailsMap == null)
                {
                    actual.ParameterNameToDetailsMap.AsTest().Must().BeNull();
                }
                else if (!actual.ParameterNameToDetailsMap.GetType().IsValueType)
                {
                    // When the declared type is a reference type, we still have to check the runtime type.
                    // The object could be a boxed value type, which will fail this asseration because
                    // a deep clone of a value type object is the same object.
                    actual.ParameterNameToDetailsMap.AsTest().Must().NotBeSameReferenceAs(systemUnderTest.ParameterNameToDetailsMap);
                }
            }
            ...
            {
                var propertyNames = new string[] { "Name", "ParameterNameToDetailsMap" };
