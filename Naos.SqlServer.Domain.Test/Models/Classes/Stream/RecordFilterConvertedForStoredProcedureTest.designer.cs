...
namespace Naos.SqlServer.Domain.Test
{
    ...
    public static partial class RecordFilterConvertedForStoredProcedureTest
    {
        ...
        private static readonly ValidModelTestScenarios<RecordFilterConvertedForStoredProcedure> ValidModelTestScenarios = new ValidModelTestScenarios<RecordFilterConvertedForStoredProcedure>()
            .AddScenario(() =>
                new ValidModelTestScenario<RecordFilterConvertedForStoredProcedure>
                {
                    Name = "a dummy RecordFilterConvertedForStoredProcedure should be valid",
                    SystemUnderTest = A.Dummy<RecordFilterConvertedForStoredProcedure>(),
                });
