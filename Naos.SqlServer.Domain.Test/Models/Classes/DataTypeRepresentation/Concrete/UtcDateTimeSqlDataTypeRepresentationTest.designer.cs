...
namespace Naos.SqlServer.Domain.Test
{
    ...
    public static partial class UtcDateTimeSqlDataTypeRepresentationTest
    {
        ...
        private static readonly ValidModelTestScenarios<UtcDateTimeSqlDataTypeRepresentation> ValidModelTestScenarios = new ValidModelTestScenarios<UtcDateTimeSqlDataTypeRepresentation>()
            .AddScenario(() =>
                new ValidModelTestScenario<UtcDateTimeSqlDataTypeRepresentation>
                {
                    Name = "a dummy UtcDateTimeSqlDataTypeRepresentation should be valid",
                    SystemUnderTest = A.Dummy<UtcDateTimeSqlDataTypeRepresentation>(),
                });
