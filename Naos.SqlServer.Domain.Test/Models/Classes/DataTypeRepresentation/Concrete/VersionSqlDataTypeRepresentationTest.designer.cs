...
namespace Naos.SqlServer.Domain.Test
{
    ...
    public static partial class VersionSqlDataTypeRepresentationTest
    {
        ...
        private static readonly ValidModelTestScenarios<VersionSqlDataTypeRepresentation> ValidModelTestScenarios = new ValidModelTestScenarios<VersionSqlDataTypeRepresentation>()
            .AddScenario(() =>
                new ValidModelTestScenario<VersionSqlDataTypeRepresentation>
                {
                    Name = "a dummy VersionSqlDataTypeRepresentation should be valid",
                    SystemUnderTest = A.Dummy<VersionSqlDataTypeRepresentation>(),
                });
