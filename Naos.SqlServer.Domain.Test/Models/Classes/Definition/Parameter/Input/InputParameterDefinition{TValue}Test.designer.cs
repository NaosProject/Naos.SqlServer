...
namespace Naos.SqlServer.Domain.Test
{
    ...
    public static partial class InputParameterDefinitionTValueTest
    {
        ...
        private static readonly ValidModelTestScenarios<InputParameterDefinition<Version>> ValidModelTestScenarios = new ValidModelTestScenarios<InputParameterDefinition<Version>>()
            .AddScenario(() =>
                new ValidModelTestScenario<InputParameterDefinition<Version>>
                {
                    Name = "a dummy InputParameterDefinition<Version> should be valid",
                    SystemUnderTest = A.Dummy<InputParameterDefinition<Version>>(),
                });
