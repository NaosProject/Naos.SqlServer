...
namespace Naos.SqlServer.Domain.Test
{
    ...
    public static partial class ColumnDefinitionTest
    {
                ...
                new StringRepresentationTestScenario<ColumnDefinition>
                {
                    ...
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedStringRepresentation<ColumnDefinition>
                        {
                            ...
                            ExpectedStringRepresentation = Invariant($"Naos.SqlServer.Domain.ColumnDefinition: Name = {systemUnderTest.Name?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, SqlDataType = {systemUnderTest.SqlDataType?.ToString() ?? "<null>"}."),
                        };
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<ColumnDefinition>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<ColumnDefinition>().ThatIs(_ => !systemUnderTest.Name.IsEqualTo(_.Name));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<ColumnDefinition>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<ColumnDefinition>().ThatIs(_ => !systemUnderTest.SqlDataType.IsEqualTo(_.SqlDataType));
        ...
        private static readonly EquatableTestScenarios<ColumnDefinition> EquatableTestScenarios = new EquatableTestScenarios<ColumnDefinition>()
            .AddScenario(() =>
                new EquatableTestScenario<ColumnDefinition>
                {
                    ...
                    {
                        new ColumnDefinition(
                                A.Dummy<ColumnDefinition>().Whose(_ => !_.Name.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Name)).Name,
                                ReferenceObjectForEquatableTestScenarios.SqlDataType),
                        new ColumnDefinition(
                                ReferenceObjectForEquatableTestScenarios.Name,
                                A.Dummy<ColumnDefinition>().Whose(_ => !_.SqlDataType.IsEqualTo(ReferenceObjectForEquatableTestScenarios.SqlDataType)).SqlDataType),
                    },
        ...
        private static readonly ValidModelTestScenarios<ColumnDefinition> ValidModelTestScenarios = new ValidModelTestScenarios<ColumnDefinition>()
            .AddScenario(() =>
                new ValidModelTestScenario<ColumnDefinition>
                {
                    Name = "a dummy ColumnDefinition should be valid",
                    SystemUnderTest = A.Dummy<ColumnDefinition>(),
                });
