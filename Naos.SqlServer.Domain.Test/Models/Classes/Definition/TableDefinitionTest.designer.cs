...
namespace Naos.SqlServer.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<TableDefinition> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<TableDefinition>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<TableDefinition>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<TableDefinition>();

                        var result = new SystemUnderTestExpectedStringRepresentation<TableDefinition>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.SqlServer.Domain.TableDefinition: Name = {systemUnderTest.Name?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Columns = {systemUnderTest.Columns?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<TableDefinition> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<TableDefinition>()
            .AddScenario(() =>
            ...
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<TableDefinition>
                {
                    ...
                    ConstructionFunc = () =>
                    {
                        ...
                        var result = new TableDefinition(
                                             referenceObject.Name,
                                             new ColumnDefinition[0].Concat(referenceObject.Columns).Concat(new ColumnDefinition[] { null }).Concat(referenceObject.Columns).ToList());
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<TableDefinition> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<TableDefinition>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<TableDefinition>
                {
                    ...
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<TableDefinition>
                        {
                            SystemUnderTest = new TableDefinition(
                                                      referenceObject.Name,
                                                      referenceObject.Columns),
        ...
        private static readonly DeepCloneWithTestScenarios<TableDefinition> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<TableDefinition>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<TableDefinition>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<TableDefinition>().ThatIs(_ => !systemUnderTest.Name.IsEqualTo(_.Name));

                        var result = new SystemUnderTestDeepCloneWithValue<TableDefinition>
                        {
                            SystemUnderTest = systemUnderTest,
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<TableDefinition>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<TableDefinition>().ThatIs(_ => !systemUnderTest.Columns.IsEqualTo(_.Columns));
        ...
        private static readonly TableDefinition ReferenceObjectForEquatableTestScenarios = A.Dummy<TableDefinition>();

        private static readonly EquatableTestScenarios<TableDefinition> EquatableTestScenarios = new EquatableTestScenarios<TableDefinition>()
            .AddScenario(() =>
                new EquatableTestScenario<TableDefinition>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new TableDefinition[]
                    {
                        new TableDefinition(
                                ReferenceObjectForEquatableTestScenarios.Name,
                                ReferenceObjectForEquatableTestScenarios.Columns),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new TableDefinition[]
                    {
                        new TableDefinition(
                                A.Dummy<TableDefinition>().Whose(_ => !_.Name.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Name)).Name,
                                ReferenceObjectForEquatableTestScenarios.Columns),
                        new TableDefinition(
                                ReferenceObjectForEquatableTestScenarios.Name,
                                A.Dummy<TableDefinition>().Whose(_ => !_.Columns.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Columns)).Columns),
                    },
        ...
        private static readonly ValidModelTestScenarios<TableDefinition> ValidModelTestScenarios = new ValidModelTestScenarios<TableDefinition>()
            .AddScenario(() =>
                new ValidModelTestScenario<TableDefinition>
                {
                    Name = "a dummy TableDefinition should be valid",
                    SystemUnderTest = A.Dummy<TableDefinition>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void TableDefinition___Should_implement_IModel_of_TableDefinition___When_reflecting()
            {
                // Arrange
                var type = typeof(TableDefinition);

                var expectedModelMethods = typeof(IModel<TableDefinition>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<TableDefinition>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void TableDefinition___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(TableDefinition);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (TableDefinition)systemUnderTest.Clone();
            ...
            {
                var propertyNames = new string[] { "Name", "Columns" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (TableDefinition)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(TableDefinition).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<TableDefinition>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                TableDefinition systemUnderTest1 = null;
                TableDefinition systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    TableDefinition systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_TableDefinition___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_TableDefinition___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_TableDefinition___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_TableDefinition___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_TableDefinition___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
