                ...
                new StringRepresentationTestScenario<ColumnRepresentation>
                {
                    ...
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedStringRepresentation<ColumnRepresentation>
                        {
                            ...
                            ExpectedStringRepresentation = Invariant($"Naos.SqlServer.Domain.ColumnRepresentation: Name = {systemUnderTest.Name?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, SqlDataType = {systemUnderTest.SqlDataType?.ToString() ?? "<null>"}."),
                        };
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<ColumnRepresentation>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<ColumnRepresentation>().ThatIs(_ => !systemUnderTest.SqlDataType.IsEqualTo(_.SqlDataType));
            ...
            .AddScenario(() =>
                new EquatableTestScenario<ColumnRepresentation>
                {
                    ...
                    ObjectsThatAreNotEqualToReferenceObject = new ColumnRepresentation[]
                    {
                        ...
                        new ColumnRepresentation(
                                ReferenceObjectForEquatableTestScenarios.Name,
                                A.Dummy<ColumnRepresentation>().Whose(_ => !_.SqlDataType.IsEqualTo(ReferenceObjectForEquatableTestScenarios.SqlDataType)).SqlDataType),
                    },
