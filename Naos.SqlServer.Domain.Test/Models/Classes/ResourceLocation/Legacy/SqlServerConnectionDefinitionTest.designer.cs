...
namespace Naos.SqlServer.Domain.Test
{
    ...
    public static partial class SqlServerConnectionDefinitionTest
    {
        ...
        private static readonly ValidModelTestScenarios<SqlServerConnectionDefinition> ValidModelTestScenarios = new ValidModelTestScenarios<SqlServerConnectionDefinition>()
            .AddScenario(() =>
                new ValidModelTestScenario<SqlServerConnectionDefinition>
                {
                    Name = "a dummy SqlServerConnectionDefinition should be valid",
                    SystemUnderTest = A.Dummy<SqlServerConnectionDefinition>(),
                });
