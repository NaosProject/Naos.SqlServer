...
namespace Naos.SqlServer.Domain.Test
{
    ...
    public static partial class SqlServerLocatorTest
    {
        ...
        private static readonly ValidModelTestScenarios<SqlServerLocator> ValidModelTestScenarios = new ValidModelTestScenarios<SqlServerLocator>()
            .AddScenario(() =>
                new ValidModelTestScenario<SqlServerLocator>
                {
                    Name = "a dummy SqlServerLocator should be valid",
                    SystemUnderTest = A.Dummy<SqlServerLocator>(),
                });
