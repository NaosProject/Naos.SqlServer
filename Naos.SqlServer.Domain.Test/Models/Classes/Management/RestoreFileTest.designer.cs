...
namespace Naos.SqlServer.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<RestoreFile> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<RestoreFile>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<RestoreFile>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<RestoreFile>();

                        var result = new SystemUnderTestExpectedStringRepresentation<RestoreFile>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.SqlServer.Domain.RestoreFile: LogicalName = {systemUnderTest.LogicalName?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, PhysicalName = {systemUnderTest.PhysicalName?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Type = {systemUnderTest.Type?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<RestoreFile> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<RestoreFile>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<RestoreFile>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'logicalName' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<RestoreFile>();

                        var result = new RestoreFile(
                                             null,
                                             referenceObject.PhysicalName,
                                             referenceObject.Type);

                        return result;
                    },
                    ExpectedExceptionType = typeof(ArgumentNullException),
                    ExpectedExceptionMessageContains = new[] { "logicalName", },
                })
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<RestoreFile>
                {
                    Name = "constructor should throw ArgumentException when parameter 'logicalName' is white space scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<RestoreFile>();
                    ...
                    ExpectedExceptionMessageContains = new[] { "logicalName", "white space", },
                })
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<RestoreFile>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'physicalName' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<RestoreFile>();

                        var result = new RestoreFile(
                                             referenceObject.LogicalName,
                                             null,
                                             referenceObject.Type);
                    ...
                    ExpectedExceptionType = typeof(ArgumentNullException),
                    ExpectedExceptionMessageContains = new[] { "physicalName", },
                })
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<RestoreFile>
                {
                    Name = "constructor should throw ArgumentException when parameter 'physicalName' is white space scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<RestoreFile>();
                    ...
                    ExpectedExceptionType = typeof(ArgumentException),
                    ExpectedExceptionMessageContains = new[] { "physicalName", "white space", },
                })
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<RestoreFile>
                {
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<RestoreFile> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<RestoreFile>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<RestoreFile>
                {
                    Name = "LogicalName should return same 'logicalName' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<RestoreFile>();

                        var result = new SystemUnderTestExpectedPropertyValue<RestoreFile>
                        {
                            SystemUnderTest = new RestoreFile(
                                                      referenceObject.LogicalName,
                                                      referenceObject.PhysicalName,
                                                      referenceObject.Type),
                            ExpectedPropertyValue = referenceObject.LogicalName,
                        };
            ...
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<RestoreFile>
                {
                    Name = "PhysicalName should return same 'physicalName' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<RestoreFile>();
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<RestoreFile>
                        {
                            SystemUnderTest = new RestoreFile(
                                                      ...
                                                      referenceObject.PhysicalName,
                                                      referenceObject.Type),
                            ExpectedPropertyValue = referenceObject.PhysicalName,
                        };
        ...
        private static readonly DeepCloneWithTestScenarios<RestoreFile> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<RestoreFile>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<RestoreFile>
                {
                    Name = "DeepCloneWithLogicalName should deep clone object and replace LogicalName with the provided logicalName",
                    WithPropertyName = "LogicalName",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<RestoreFile>();

                        var referenceObject = A.Dummy<RestoreFile>().ThatIs(_ => !systemUnderTest.LogicalName.IsEqualTo(_.LogicalName));

                        var result = new SystemUnderTestDeepCloneWithValue<RestoreFile>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.LogicalName,
                        };
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<RestoreFile>
                {
                    Name = "DeepCloneWithPhysicalName should deep clone object and replace PhysicalName with the provided physicalName",
                    WithPropertyName = "PhysicalName",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<RestoreFile>();

                        var referenceObject = A.Dummy<RestoreFile>().ThatIs(_ => !systemUnderTest.PhysicalName.IsEqualTo(_.PhysicalName));

                        var result = new SystemUnderTestDeepCloneWithValue<RestoreFile>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.PhysicalName,
                        };
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<RestoreFile>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<RestoreFile>().ThatIs(_ => !systemUnderTest.Type.IsEqualTo(_.Type));
        ...
        private static readonly RestoreFile ReferenceObjectForEquatableTestScenarios = A.Dummy<RestoreFile>();

        private static readonly EquatableTestScenarios<RestoreFile> EquatableTestScenarios = new EquatableTestScenarios<RestoreFile>()
            .AddScenario(() =>
                new EquatableTestScenario<RestoreFile>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new RestoreFile[]
                    {
                        new RestoreFile(
                                ReferenceObjectForEquatableTestScenarios.LogicalName,
                                ReferenceObjectForEquatableTestScenarios.PhysicalName,
                                ReferenceObjectForEquatableTestScenarios.Type),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new RestoreFile[]
                    {
                        new RestoreFile(
                                A.Dummy<RestoreFile>().Whose(_ => !_.LogicalName.IsEqualTo(ReferenceObjectForEquatableTestScenarios.LogicalName)).LogicalName,
                                ReferenceObjectForEquatableTestScenarios.PhysicalName,
                                ReferenceObjectForEquatableTestScenarios.Type),
                        new RestoreFile(
                                ReferenceObjectForEquatableTestScenarios.LogicalName,
                                A.Dummy<RestoreFile>().Whose(_ => !_.PhysicalName.IsEqualTo(ReferenceObjectForEquatableTestScenarios.PhysicalName)).PhysicalName,
                                ReferenceObjectForEquatableTestScenarios.Type),
                        new RestoreFile(
                                ReferenceObjectForEquatableTestScenarios.LogicalName,
                                ReferenceObjectForEquatableTestScenarios.PhysicalName,
                                A.Dummy<RestoreFile>().Whose(_ => !_.Type.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Type)).Type),
                    },
        ...
        private static readonly ValidModelTestScenarios<RestoreFile> ValidModelTestScenarios = new ValidModelTestScenarios<RestoreFile>()
            .AddScenario(() =>
                new ValidModelTestScenario<RestoreFile>
                {
                    Name = "a dummy RestoreFile should be valid",
                    SystemUnderTest = A.Dummy<RestoreFile>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void RestoreFile___Should_implement_IModel_of_RestoreFile___When_reflecting()
            {
                // Arrange
                var type = typeof(RestoreFile);

                var expectedModelMethods = typeof(IModel<RestoreFile>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<RestoreFile>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void RestoreFile___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(RestoreFile);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (RestoreFile)systemUnderTest.Clone();
            ...
            {
                var propertyNames = new string[] { "LogicalName", "PhysicalName", "Type" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (RestoreFile)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(RestoreFile).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<RestoreFile>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                RestoreFile systemUnderTest1 = null;
                RestoreFile systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    RestoreFile systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_RestoreFile___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_RestoreFile___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_RestoreFile___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_RestoreFile___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_RestoreFile___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
