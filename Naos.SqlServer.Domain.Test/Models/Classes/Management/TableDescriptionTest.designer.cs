...
namespace Naos.SqlServer.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<TableDescription> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<TableDescription>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<TableDescription>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<TableDescription>();

                        var result = new SystemUnderTestExpectedStringRepresentation<TableDescription>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.SqlServer.Domain.TableDescription: DatabaseName = {systemUnderTest.DatabaseName?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, TableSchema = {systemUnderTest.TableSchema?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, TableName = {systemUnderTest.TableName?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Columns = {systemUnderTest.Columns?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<TableDescription> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<TableDescription>()
            .AddScenario(() =>
            ...
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<TableDescription>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'tableSchema' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<TableDescription>();
                    ...
                    ExpectedExceptionType = typeof(ArgumentNullException),
                    ExpectedExceptionMessageContains = new[] { "tableSchema", },
                })
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<TableDescription>
                {
                    Name = "constructor should throw ArgumentException when parameter 'tableSchema' is white space scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<TableDescription>();
                    ...
                    ExpectedExceptionType = typeof(ArgumentException),
                    ExpectedExceptionMessageContains = new[] { "tableSchema", "white space", },
                })
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<TableDescription>
                {
                ...
                new ConstructorArgumentValidationTestScenario<TableDescription>
                {
                    ...
                    ConstructionFunc = () =>
                    {
                        ...
                        var result = new TableDescription(
                                             ...
                                             referenceObject.TableSchema,
                                             referenceObject.TableName,
                                             new ColumnDescription[0].Concat(referenceObject.Columns).Concat(new ColumnDescription[] { null }).Concat(referenceObject.Columns).ToList());
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<TableDescription> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<TableDescription>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<TableDescription>
                {
                    ...
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<TableDescription>
                        {
                            SystemUnderTest = new TableDescription(
                                                      referenceObject.DatabaseName,
                                                      referenceObject.TableSchema,
                                                      referenceObject.TableName,
                                                      referenceObject.Columns),
            ...
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<TableDescription>
                {
                    Name = "TableSchema should return same 'tableSchema' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<TableDescription>();
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<TableDescription>
                        {
                            SystemUnderTest = new TableDescription(
                                                      ...
                                                      referenceObject.TableName,
                                                      referenceObject.Columns),
                            ExpectedPropertyValue = referenceObject.TableSchema,
                        };
        ...
        private static readonly DeepCloneWithTestScenarios<TableDescription> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<TableDescription>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<TableDescription>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<TableDescription>().ThatIs(_ => !systemUnderTest.DatabaseName.IsEqualTo(_.DatabaseName));

                        var result = new SystemUnderTestDeepCloneWithValue<TableDescription>
                        {
                            SystemUnderTest = systemUnderTest,
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<TableDescription>
                {
                    Name = "DeepCloneWithTableSchema should deep clone object and replace TableSchema with the provided tableSchema",
                    WithPropertyName = "TableSchema",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<TableDescription>();

                        var referenceObject = A.Dummy<TableDescription>().ThatIs(_ => !systemUnderTest.TableSchema.IsEqualTo(_.TableSchema));

                        var result = new SystemUnderTestDeepCloneWithValue<TableDescription>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.TableSchema,
                        };
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<TableDescription>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<TableDescription>().ThatIs(_ => !systemUnderTest.TableName.IsEqualTo(_.TableName));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<TableDescription>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<TableDescription>().ThatIs(_ => !systemUnderTest.Columns.IsEqualTo(_.Columns));
        ...
        private static readonly TableDescription ReferenceObjectForEquatableTestScenarios = A.Dummy<TableDescription>();

        private static readonly EquatableTestScenarios<TableDescription> EquatableTestScenarios = new EquatableTestScenarios<TableDescription>()
            .AddScenario(() =>
                new EquatableTestScenario<TableDescription>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new TableDescription[]
                    {
                        new TableDescription(
                                ReferenceObjectForEquatableTestScenarios.DatabaseName,
                                ReferenceObjectForEquatableTestScenarios.TableSchema,
                                ReferenceObjectForEquatableTestScenarios.TableName,
                                ReferenceObjectForEquatableTestScenarios.Columns),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new TableDescription[]
                    {
                        new TableDescription(
                                A.Dummy<TableDescription>().Whose(_ => !_.DatabaseName.IsEqualTo(ReferenceObjectForEquatableTestScenarios.DatabaseName)).DatabaseName,
                                ReferenceObjectForEquatableTestScenarios.TableSchema,
                                ReferenceObjectForEquatableTestScenarios.TableName,
                                ReferenceObjectForEquatableTestScenarios.Columns),
                        new TableDescription(
                                ReferenceObjectForEquatableTestScenarios.DatabaseName,
                                A.Dummy<TableDescription>().Whose(_ => !_.TableSchema.IsEqualTo(ReferenceObjectForEquatableTestScenarios.TableSchema)).TableSchema,
                                ReferenceObjectForEquatableTestScenarios.TableName,
                                ReferenceObjectForEquatableTestScenarios.Columns),
                        new TableDescription(
                                ReferenceObjectForEquatableTestScenarios.DatabaseName,
                                ReferenceObjectForEquatableTestScenarios.TableSchema,
                                A.Dummy<TableDescription>().Whose(_ => !_.TableName.IsEqualTo(ReferenceObjectForEquatableTestScenarios.TableName)).TableName,
                                ReferenceObjectForEquatableTestScenarios.Columns),
                        new TableDescription(
                                ReferenceObjectForEquatableTestScenarios.DatabaseName,
                                ReferenceObjectForEquatableTestScenarios.TableSchema,
                                ReferenceObjectForEquatableTestScenarios.TableName,
                                A.Dummy<TableDescription>().Whose(_ => !_.Columns.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Columns)).Columns),
                    },
        ...
        private static readonly ValidModelTestScenarios<TableDescription> ValidModelTestScenarios = new ValidModelTestScenarios<TableDescription>()
            .AddScenario(() =>
                new ValidModelTestScenario<TableDescription>
                {
                    Name = "a dummy TableDescription should be valid",
                    SystemUnderTest = A.Dummy<TableDescription>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void TableDescription___Should_implement_IModel_of_TableDescription___When_reflecting()
            {
                // Arrange
                var type = typeof(TableDescription);

                var expectedModelMethods = typeof(IModel<TableDescription>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<TableDescription>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void TableDescription___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(TableDescription);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (TableDescription)systemUnderTest.Clone();
            ...
            {
                var propertyNames = new string[] { "DatabaseName", "TableSchema", "TableName", "Columns" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (TableDescription)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(TableDescription).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<TableDescription>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                TableDescription systemUnderTest1 = null;
                TableDescription systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    TableDescription systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_TableDescription___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_TableDescription___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_TableDescription___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_TableDescription___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_TableDescription___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
