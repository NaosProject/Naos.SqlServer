...
namespace Naos.SqlServer.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<ScriptedObject> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<ScriptedObject>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<ScriptedObject>
                {
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<ScriptedObject> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<ScriptedObject>()
            .AddScenario(() =>
            ...
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<ScriptedObject>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'dropScript' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<ScriptedObject>();
                    ...
                    ExpectedExceptionType = typeof(ArgumentNullException),
                    ExpectedExceptionMessageContains = new[] { "dropScript", },
                })
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<ScriptedObject>
                {
                    Name = "constructor should throw ArgumentException when parameter 'dropScript' is white space scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<ScriptedObject>();
                    ...
                    ExpectedExceptionType = typeof(ArgumentException),
                    ExpectedExceptionMessageContains = new[] { "dropScript", "white space", },
                })
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<ScriptedObject>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'createScript' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<ScriptedObject>();
                    ...
                    ExpectedExceptionType = typeof(ArgumentNullException),
                    ExpectedExceptionMessageContains = new[] { "createScript", },
                })
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<ScriptedObject>
                {
                    Name = "constructor should throw ArgumentException when parameter 'createScript' is white space scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<ScriptedObject>();
                    ...
                    ExpectedExceptionType = typeof(ArgumentException),
                    ExpectedExceptionMessageContains = new[] { "createScript", "white space", },
                });

        private static readonly ConstructorPropertyAssignmentTestScenarios<ScriptedObject> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<ScriptedObject>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<ScriptedObject>
                {
                    ...
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<ScriptedObject>
                        {
            ...
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<ScriptedObject>
                {
                    Name = "DropScript should return same 'dropScript' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<ScriptedObject>();
                    ...
                    PropertyName = "DropScript",
                })
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<ScriptedObject>
                {
                    Name = "CreateScript should return same 'createScript' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<ScriptedObject>();
                    ...
                    PropertyName = "CreateScript",
                });

        private static readonly DeepCloneWithTestScenarios<ScriptedObject> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<ScriptedObject>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<ScriptedObject>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<ScriptedObject>().ThatIs(_ => !systemUnderTest.Name.IsEqualTo(_.Name));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<ScriptedObject>
                {
                    Name = "DeepCloneWithDropScript should deep clone object and replace DropScript with the provided dropScript",
                    WithPropertyName = "DropScript",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<ScriptedObject>();

                        var referenceObject = A.Dummy<ScriptedObject>().ThatIs(_ => !systemUnderTest.DropScript.IsEqualTo(_.DropScript));

                        var result = new SystemUnderTestDeepCloneWithValue<ScriptedObject>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.DropScript,
                        };
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<ScriptedObject>
                {
                    Name = "DeepCloneWithCreateScript should deep clone object and replace CreateScript with the provided createScript",
                    WithPropertyName = "CreateScript",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<ScriptedObject>();

                        var referenceObject = A.Dummy<ScriptedObject>().ThatIs(_ => !systemUnderTest.CreateScript.IsEqualTo(_.CreateScript));

                        var result = new SystemUnderTestDeepCloneWithValue<ScriptedObject>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.CreateScript,
                        };
        ...
        private static readonly ScriptedObject ReferenceObjectForEquatableTestScenarios = A.Dummy<ScriptedObject>();

        private static readonly EquatableTestScenarios<ScriptedObject> EquatableTestScenarios = new EquatableTestScenarios<ScriptedObject>()
            .AddScenario(() =>
                new EquatableTestScenario<ScriptedObject>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new ScriptedObject[]
                    {
                        new ScriptedObject(
                    ...
                    ObjectsThatAreNotEqualToReferenceObject = new ScriptedObject[]
                    {
                        new ScriptedObject(
        ...
        private static readonly ValidModelTestScenarios<ScriptedObject> ValidModelTestScenarios = new ValidModelTestScenarios<ScriptedObject>()
            .AddScenario(() =>
                new ValidModelTestScenario<ScriptedObject>
                {
                    Name = "a dummy ScriptedObject should be valid",
                    SystemUnderTest = A.Dummy<ScriptedObject>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void ScriptedObject___Should_implement_IModel_of_ScriptedObject___When_reflecting()
            {
                // Arrange
                var type = typeof(ScriptedObject);

                var expectedModelMethods = typeof(IModel<ScriptedObject>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<ScriptedObject>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void ScriptedObject___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(ScriptedObject);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (ScriptedObject)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (ScriptedObject)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(ScriptedObject).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<ScriptedObject>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                ScriptedObject systemUnderTest1 = null;
                ScriptedObject systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    ScriptedObject systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ScriptedObject___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ScriptedObject___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ScriptedObject___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ScriptedObject___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ScriptedObject___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
