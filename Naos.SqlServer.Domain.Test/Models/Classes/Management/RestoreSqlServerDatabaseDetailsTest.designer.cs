...
namespace Naos.SqlServer.Domain.Test
{
    ...
    public static partial class RestoreSqlServerDatabaseDetailsTest
    {
        ...
        private static readonly ValidModelTestScenarios<RestoreSqlServerDatabaseDetails> ValidModelTestScenarios = new ValidModelTestScenarios<RestoreSqlServerDatabaseDetails>()
            .AddScenario(() =>
                new ValidModelTestScenario<RestoreSqlServerDatabaseDetails>
                {
                    Name = "a dummy RestoreSqlServerDatabaseDetails should be valid",
                    SystemUnderTest = A.Dummy<RestoreSqlServerDatabaseDetails>(),
                });
