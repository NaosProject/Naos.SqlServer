...
namespace Naos.SqlServer.Domain.Test
{
    ...
    public static partial class BackupSqlServerDatabaseDetailsTest
    {
        ...
        private static readonly ValidModelTestScenarios<BackupSqlServerDatabaseDetails> ValidModelTestScenarios = new ValidModelTestScenarios<BackupSqlServerDatabaseDetails>()
            .AddScenario(() =>
                new ValidModelTestScenario<BackupSqlServerDatabaseDetails>
                {
                    Name = "a dummy BackupSqlServerDatabaseDetails should be valid",
                    SystemUnderTest = A.Dummy<BackupSqlServerDatabaseDetails>(),
                });
        ...
        public static class CloningTesting
        {
            ...
            public static void DeepClone___Should_deep_clone_object___When_called()
            {
                ...
                else if (!actual.BackupTo.GetType().IsValueType)
                {
