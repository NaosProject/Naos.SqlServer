...
namespace Naos.SqlServer.Domain.Test
{
    ...
    public static partial class RestoreSqlServerDatabaseDetailsTest
    {
        ...
        private static readonly DeepCloneWithTestScenarios<RestoreSqlServerDatabaseDetails> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<RestoreSqlServerDatabaseDetails>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<RestoreSqlServerDatabaseDetails>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<RestoreSqlServerDatabaseDetails>().ThatIs(_ => !systemUnderTest.ChecksumOption.IsEqualTo(_.ChecksumOption));

                        var result = new SystemUnderTestDeepCloneWithValue<RestoreSqlServerDatabaseDetails>
                        {
                            SystemUnderTest = systemUnderTest,
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<RestoreSqlServerDatabaseDetails>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<RestoreSqlServerDatabaseDetails>().ThatIs(_ => !systemUnderTest.Credential.IsEqualTo(_.Credential));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<RestoreSqlServerDatabaseDetails>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<RestoreSqlServerDatabaseDetails>().ThatIs(_ => !systemUnderTest.DataFilePath.IsEqualTo(_.DataFilePath));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<RestoreSqlServerDatabaseDetails>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<RestoreSqlServerDatabaseDetails>().ThatIs(_ => !systemUnderTest.Device.IsEqualTo(_.Device));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<RestoreSqlServerDatabaseDetails>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<RestoreSqlServerDatabaseDetails>().ThatIs(_ => !systemUnderTest.ErrorHandling.IsEqualTo(_.ErrorHandling));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<RestoreSqlServerDatabaseDetails>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<RestoreSqlServerDatabaseDetails>().ThatIs(_ => !systemUnderTest.LogFilePath.IsEqualTo(_.LogFilePath));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<RestoreSqlServerDatabaseDetails>
                {
                    Name = "DeepCloneWithRecoveryOption should deep clone object and replace RecoveryOption with the provided recoveryOption",
                    WithPropertyName = "RecoveryOption",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<RestoreSqlServerDatabaseDetails>();

                        var referenceObject = A.Dummy<RestoreSqlServerDatabaseDetails>().ThatIs(_ => !systemUnderTest.RecoveryOption.IsEqualTo(_.RecoveryOption));

                        var result = new SystemUnderTestDeepCloneWithValue<RestoreSqlServerDatabaseDetails>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.RecoveryOption,
                        };
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<RestoreSqlServerDatabaseDetails>
                {
                    Name = "DeepCloneWithReplaceOption should deep clone object and replace ReplaceOption with the provided replaceOption",
                    WithPropertyName = "ReplaceOption",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<RestoreSqlServerDatabaseDetails>();

                        var referenceObject = A.Dummy<RestoreSqlServerDatabaseDetails>().ThatIs(_ => !systemUnderTest.ReplaceOption.IsEqualTo(_.ReplaceOption));

                        var result = new SystemUnderTestDeepCloneWithValue<RestoreSqlServerDatabaseDetails>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.ReplaceOption,
                        };
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<RestoreSqlServerDatabaseDetails>
                {
                    Name = "DeepCloneWithRestoreFrom should deep clone object and replace RestoreFrom with the provided restoreFrom",
                    WithPropertyName = "RestoreFrom",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<RestoreSqlServerDatabaseDetails>();

                        var referenceObject = A.Dummy<RestoreSqlServerDatabaseDetails>().ThatIs(_ => !systemUnderTest.RestoreFrom.IsEqualTo(_.RestoreFrom));

                        var result = new SystemUnderTestDeepCloneWithValue<RestoreSqlServerDatabaseDetails>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.RestoreFrom,
                        };
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<RestoreSqlServerDatabaseDetails>
                {
                    Name = "DeepCloneWithRestrictedUserOption should deep clone object and replace RestrictedUserOption with the provided restrictedUserOption",
                    WithPropertyName = "RestrictedUserOption",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<RestoreSqlServerDatabaseDetails>();

                        var referenceObject = A.Dummy<RestoreSqlServerDatabaseDetails>().ThatIs(_ => !systemUnderTest.RestrictedUserOption.IsEqualTo(_.RestrictedUserOption));

                        var result = new SystemUnderTestDeepCloneWithValue<RestoreSqlServerDatabaseDetails>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.RestrictedUserOption,
                        };
        ...
        public static class Cloning
        {
            ...
            {
                var propertyNames = new string[] { "ChecksumOption", "Credential", "DataFilePath", "Device", "ErrorHandling", "LogFilePath", "RecoveryOption", "ReplaceOption", "RestoreFrom", "RestrictedUserOption" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (RestoreSqlServerDatabaseDetails)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(RestoreSqlServerDatabaseDetails).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
