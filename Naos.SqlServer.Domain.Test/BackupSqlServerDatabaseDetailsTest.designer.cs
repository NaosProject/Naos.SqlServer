...
namespace Naos.SqlServer.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<BackupSqlServerDatabaseDetails> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<BackupSqlServerDatabaseDetails>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<BackupSqlServerDatabaseDetails>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<BackupSqlServerDatabaseDetails>();

                        var result = new SystemUnderTestExpectedStringRepresentation<BackupSqlServerDatabaseDetails>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.SqlServer.Domain.BackupSqlServerDatabaseDetails: BackupTo = {systemUnderTest.BackupTo?.ToString() ?? "<null>"}, ChecksumOption = {systemUnderTest.ChecksumOption.ToString() ?? "<null>"}, Cipher = {systemUnderTest.Cipher.ToString() ?? "<null>"}, CompressionOption = {systemUnderTest.CompressionOption.ToString() ?? "<null>"}, Credential = {systemUnderTest.Credential?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Description = {systemUnderTest.Description?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Device = {systemUnderTest.Device.ToString() ?? "<null>"}, Encryptor = {systemUnderTest.Encryptor.ToString() ?? "<null>"}, EncryptorName = {systemUnderTest.EncryptorName?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, ErrorHandling = {systemUnderTest.ErrorHandling.ToString() ?? "<null>"}, Name = {systemUnderTest.Name?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<BackupSqlServerDatabaseDetails> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<BackupSqlServerDatabaseDetails>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<BackupSqlServerDatabaseDetails>
                {
                    ...
                    ExpectedExceptionMessageContains = new[] { "backupTo" },
                })
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<BackupSqlServerDatabaseDetails>
                {
            ...
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<BackupSqlServerDatabaseDetails>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'encryptorName' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<BackupSqlServerDatabaseDetails>();
                    ...
                    ExpectedExceptionType = typeof(ArgumentNullException),
                    ExpectedExceptionMessageContains = new[] { "encryptorName" },
                })
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<BackupSqlServerDatabaseDetails>
                {
                    Name = "constructor should throw ArgumentException when parameter 'encryptorName' is white space scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<BackupSqlServerDatabaseDetails>();
                    ...
                    ExpectedExceptionType = typeof(ArgumentException),
                    ExpectedExceptionMessageContains = new[] { "encryptorName", "white space" },
                })
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<BackupSqlServerDatabaseDetails>
                {
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<BackupSqlServerDatabaseDetails> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<BackupSqlServerDatabaseDetails>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<BackupSqlServerDatabaseDetails>
                {
                    Name = "BackupTo should return same 'backupTo' parameter passed to constructor when getting",
            ...
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<BackupSqlServerDatabaseDetails>
                {
                    Name = "Cipher should return same 'cipher' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<BackupSqlServerDatabaseDetails>();
            ...
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<BackupSqlServerDatabaseDetails>
                {
                    Name = "CompressionOption should return same 'compressionOption' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<BackupSqlServerDatabaseDetails>();
                    ...
                    PropertyName = "CompressionOption",
                })
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<BackupSqlServerDatabaseDetails>
                {
            ...
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<BackupSqlServerDatabaseDetails>
                {
                    Name = "Encryptor should return same 'encryptor' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<BackupSqlServerDatabaseDetails>();
                    ...
                    PropertyName = "Encryptor",
                })
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<BackupSqlServerDatabaseDetails>
                {
                    Name = "EncryptorName should return same 'encryptorName' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<BackupSqlServerDatabaseDetails>();
        ...
        private static readonly DeepCloneWithTestScenarios<BackupSqlServerDatabaseDetails> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<BackupSqlServerDatabaseDetails>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<BackupSqlServerDatabaseDetails>
                {
                    Name = "DeepCloneWithBackupTo should deep clone object and replace BackupTo with the provided backupTo",
                    WithPropertyName = "BackupTo",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<BackupSqlServerDatabaseDetails>();

                        var referenceObject = A.Dummy<BackupSqlServerDatabaseDetails>().ThatIs(_ => !systemUnderTest.BackupTo.IsEqualTo(_.BackupTo));

                        var result = new SystemUnderTestDeepCloneWithValue<BackupSqlServerDatabaseDetails>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.BackupTo,
                        };
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<BackupSqlServerDatabaseDetails>
                {
                    Name = "DeepCloneWithChecksumOption should deep clone object and replace ChecksumOption with the provided checksumOption",
                    WithPropertyName = "ChecksumOption",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<BackupSqlServerDatabaseDetails>();

                        var referenceObject = A.Dummy<BackupSqlServerDatabaseDetails>().ThatIs(_ => !systemUnderTest.ChecksumOption.IsEqualTo(_.ChecksumOption));

                        var result = new SystemUnderTestDeepCloneWithValue<BackupSqlServerDatabaseDetails>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.ChecksumOption,
                        };
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<BackupSqlServerDatabaseDetails>
                {
                    Name = "DeepCloneWithCipher should deep clone object and replace Cipher with the provided cipher",
                    WithPropertyName = "Cipher",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<BackupSqlServerDatabaseDetails>();

                        var referenceObject = A.Dummy<BackupSqlServerDatabaseDetails>().ThatIs(_ => !systemUnderTest.Cipher.IsEqualTo(_.Cipher));

                        var result = new SystemUnderTestDeepCloneWithValue<BackupSqlServerDatabaseDetails>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.Cipher,
                        };
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<BackupSqlServerDatabaseDetails>
                {
                    Name = "DeepCloneWithCompressionOption should deep clone object and replace CompressionOption with the provided compressionOption",
                    WithPropertyName = "CompressionOption",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<BackupSqlServerDatabaseDetails>();

                        var referenceObject = A.Dummy<BackupSqlServerDatabaseDetails>().ThatIs(_ => !systemUnderTest.CompressionOption.IsEqualTo(_.CompressionOption));

                        var result = new SystemUnderTestDeepCloneWithValue<BackupSqlServerDatabaseDetails>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.CompressionOption,
                        };
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<BackupSqlServerDatabaseDetails>
                {
                    Name = "DeepCloneWithCredential should deep clone object and replace Credential with the provided credential",
                    WithPropertyName = "Credential",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<BackupSqlServerDatabaseDetails>();

                        var referenceObject = A.Dummy<BackupSqlServerDatabaseDetails>().ThatIs(_ => !systemUnderTest.Credential.IsEqualTo(_.Credential));

                        var result = new SystemUnderTestDeepCloneWithValue<BackupSqlServerDatabaseDetails>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.Credential,
                        };
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<BackupSqlServerDatabaseDetails>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<BackupSqlServerDatabaseDetails>().ThatIs(_ => !systemUnderTest.Description.IsEqualTo(_.Description));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<BackupSqlServerDatabaseDetails>
                {
                    Name = "DeepCloneWithDevice should deep clone object and replace Device with the provided device",
                    WithPropertyName = "Device",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<BackupSqlServerDatabaseDetails>();

                        var referenceObject = A.Dummy<BackupSqlServerDatabaseDetails>().ThatIs(_ => !systemUnderTest.Device.IsEqualTo(_.Device));

                        var result = new SystemUnderTestDeepCloneWithValue<BackupSqlServerDatabaseDetails>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.Device,
                        };
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<BackupSqlServerDatabaseDetails>
                {
                    Name = "DeepCloneWithEncryptor should deep clone object and replace Encryptor with the provided encryptor",
                    WithPropertyName = "Encryptor",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<BackupSqlServerDatabaseDetails>();

                        var referenceObject = A.Dummy<BackupSqlServerDatabaseDetails>().ThatIs(_ => !systemUnderTest.Encryptor.IsEqualTo(_.Encryptor));

                        var result = new SystemUnderTestDeepCloneWithValue<BackupSqlServerDatabaseDetails>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.Encryptor,
                        };
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<BackupSqlServerDatabaseDetails>
                {
                    Name = "DeepCloneWithEncryptorName should deep clone object and replace EncryptorName with the provided encryptorName",
                    WithPropertyName = "EncryptorName",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<BackupSqlServerDatabaseDetails>();

                        var referenceObject = A.Dummy<BackupSqlServerDatabaseDetails>().ThatIs(_ => !systemUnderTest.EncryptorName.IsEqualTo(_.EncryptorName));

                        var result = new SystemUnderTestDeepCloneWithValue<BackupSqlServerDatabaseDetails>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.EncryptorName,
                        };
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<BackupSqlServerDatabaseDetails>
                {
                    Name = "DeepCloneWithErrorHandling should deep clone object and replace ErrorHandling with the provided errorHandling",
                    WithPropertyName = "ErrorHandling",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<BackupSqlServerDatabaseDetails>();

                        var referenceObject = A.Dummy<BackupSqlServerDatabaseDetails>().ThatIs(_ => !systemUnderTest.ErrorHandling.IsEqualTo(_.ErrorHandling));

                        var result = new SystemUnderTestDeepCloneWithValue<BackupSqlServerDatabaseDetails>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.ErrorHandling,
                        };
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<BackupSqlServerDatabaseDetails>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<BackupSqlServerDatabaseDetails>().ThatIs(_ => !systemUnderTest.Name.IsEqualTo(_.Name));
        ...
        private static readonly BackupSqlServerDatabaseDetails ReferenceObjectForEquatableTestScenarios = A.Dummy<BackupSqlServerDatabaseDetails>();

        private static readonly EquatableTestScenarios<BackupSqlServerDatabaseDetails> EquatableTestScenarios = new EquatableTestScenarios<BackupSqlServerDatabaseDetails>()
            .AddScenario(() =>
        ...
        public static class Structural
        {
            ...
            public static void BackupSqlServerDatabaseDetails___Should_implement_IModel_of_BackupSqlServerDatabaseDetails___When_reflecting()
            {
                // Arrange
                var type = typeof(BackupSqlServerDatabaseDetails);

                var expectedModelMethods = typeof(IModel<BackupSqlServerDatabaseDetails>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<BackupSqlServerDatabaseDetails>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void BackupSqlServerDatabaseDetails___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(BackupSqlServerDatabaseDetails);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (BackupSqlServerDatabaseDetails)systemUnderTest.Clone();
            ...
            public static void DeepClone___Should_deep_clone_object___When_called()
            {
                ...
                if (systemUnderTest.BackupTo == null)
                {
                    actual.BackupTo.AsTest().Must().BeNull();
                }
                else
                {
                    actual.BackupTo.AsTest().Must().NotBeSameReferenceAs(systemUnderTest.BackupTo);
                }
            }
            ...
            {
                var propertyNames = new string[] { "BackupTo", "ChecksumOption", "Cipher", "CompressionOption", "Credential", "Description", "Device", "Encryptor", "EncryptorName", "ErrorHandling", "Name" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (BackupSqlServerDatabaseDetails)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(BackupSqlServerDatabaseDetails).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<BackupSqlServerDatabaseDetails>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                BackupSqlServerDatabaseDetails systemUnderTest1 = null;
                BackupSqlServerDatabaseDetails systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    BackupSqlServerDatabaseDetails systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_BackupSqlServerDatabaseDetails___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_BackupSqlServerDatabaseDetails___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_BackupSqlServerDatabaseDetails___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_BackupSqlServerDatabaseDetails___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_BackupSqlServerDatabaseDetails___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
